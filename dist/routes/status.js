...
async function statusRoute(app) {
    app.get('/v2/status', {
        schema: {
            querystring: {
                type: 'object',
        ...
        const cacheKey = (0, redis_1.buildCacheKey)('status', { uuid });
        ...
        try {
            ...
            const data = await (0, hypixel_1.fetchFromHypixel)({ path: '/v2/status', params: { uuid } });
            await (0, redis_1.cacheSet)(cacheKey, data, index_1.config.cache.ttl.status);
